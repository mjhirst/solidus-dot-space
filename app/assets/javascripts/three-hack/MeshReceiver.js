  ...
  buildMeshes: function (meshPayload) {
    ...
    if (buffers.indices !== undefined && buffers.indices !== null) {
      bufferGeometry.setIndex(
        new THREE.BufferAttribute(new Uint32Array(buffers.indices), 1)
      );
    }
    ...
    if (buffers.colors !== undefined && buffers.colors !== null) {
      bufferGeometry.setAttribute(
        "color",
        new THREE.BufferAttribute(new Float32Array(buffers.colors), 3)
      );
    }
    ...
    if (buffers.skinIndex !== undefined && buffers.skinIndex !== null) {
      bufferGeometry.setAttribute(
        "skinIndex",
        new THREE.BufferAttribute(new Uint16Array(buffers.skinIndex), 4)
      );
    }
    ...
    if (buffers.skinWeight !== undefined && buffers.skinWeight !== null) {
      bufferGeometry.setAttribute(
        "skinWeight",
        new THREE.BufferAttribute(new Float32Array(buffers.skinWeight), 4)
      );
    }
